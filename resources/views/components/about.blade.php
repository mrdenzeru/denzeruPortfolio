<section id="about" class="w-full px-[150px] py-20">
    <div class="grid grid-cols-1 gap-10 md:grid-cols-2">
        <div>
            <p class="mb-2 text-medium font-semibold text-[#1A1A18]">About Me</p>
            <h2 class="text-5xl font-extrabold text-[#1A1A18]">
                Here to Help Bring<br>Your Ideas to Life
            </h2>
            <p class="mt-4 max-w-2xl text-sm text-[#1A1A18]">
                I'm a passionate designer and developer who loves turning ideas into meaningful digital
                experiences. With a strong eye for detail and a problem-solving mindset, I create designs
                that are not just visually appealing — but purposeful and impactful.
            </p>
            <a href="#projects"
                class="mt-6 inline-block rounded-lg bg-[#00224D] px-10 py-3 text-sm font-semibold text-white hover:bg-blue-800">
                Read More
            </a>
        </div>

        <div class="rounded-4xl bg-[#FFC30B] p-8 shadow-md">
            <h3 class="text-4xl font-extrabold text-[#1A1A18]">Connect with me</h3>
            <p class="mt-3 text-md font-medium text-[#1A1A18]">
                Let's build something great together. Whether you have a project in mind, a problem to
                solve, or just want to say hello — my inbox is always open. Feel free to reach out through
                any of my social channels below.
            </p>
            <div class="mt-5 flex gap-4 text-gray-900">
                ...
                <a href="#" aria-label="X" class="hover:opacity-70">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-12 w-12">
...
<hr class="w-full px-[150px] border-[#DFDFDF]">
