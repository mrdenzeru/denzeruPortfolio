<div class="w-full px-[100px] overflow-hidden py-14">
    <div class="flex w-max animate-marquee items-center gap-x-16 opacity-60 grayscale">
        ...
        <img src="{{ asset('images/assets/company-logo/the-nest-logo.png') }}" alt="The Nest" class="h-18 w-auto object-contain">
        <img src="{{ asset('images/assets/company-logo/microsoft-logo.png') }}" alt="Microsoft" class="h-18 w-auto object-contain">
