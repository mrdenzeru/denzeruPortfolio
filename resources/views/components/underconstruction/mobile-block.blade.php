<div class="fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-6 bg-[#00224D] px-8 text-center text-white md:hidden">
    {{-- Monitor icon --}}
    {{-- <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-[#FFC30B]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <rect x="2" y="4" width="20" height="13" rx="1.5" />
        <path d="M8 21h8" />
        <path d="M12 17v4" />
        <path d="M2 14h20" stroke-opacity="0.4" />
    </svg> --}}

    {{-- Under-construction illustration --}}
    <img
        src="{{ asset('images/assets/profiles/underconstruction.png') }}"
        alt="Under construction"
        class="w-40 max-w-[60vw] h-auto"
    >
